        ...
        return (
            <div className="space-y-4 sm:space-y-6 animate-fadeIn pb-24">
                ...
                {aniversariantesDoMes.length > 0 && (
                    <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-pink-100">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <div className="flex gap-1 p-1 bg-slate-100 rounded-xl self-start">
                        <button
                            ...
                            className={`px-3 py-2 rounded-lg text-[10px] sm:text-xs font-bold uppercase transition-all ${ordenacao === 'gastos' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-400'
                                }`}
                        >
                            💰 Top
                        </button>
                        <button
                            ...
                            className={`px-3 py-2 rounded-lg text-[10px] sm:text-xs font-bold uppercase transition-all ${ordenacao === 'nome' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-400'
                                }`}
                        >
                            A-Z
                        </button>
                ...
                <div className="space-y-3">
                    {clientesFiltrados.map((cliente, index) => (
                        <div
                            key={cliente.id}
                            className={`bg-white rounded-xl sm:rounded-2xl p-4 border border-slate-100 shadow-sm hover:shadow-md transition-all cursor-pointer active:scale-[0.99] ${isAniversariante(cliente.aniversario) ? 'ring-2 ring-pink-200' : ''
                                }`}
